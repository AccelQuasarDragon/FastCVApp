...
# why is this so slow but also smooth? 0.3040013313293457 0.016666666666666666
# google/mediapipe#1160 (comment)
# MediaPipe graphs will queue/drop frames when the input is faster than the system can handle.
# The more powerful the device (or more simple the graph), the less frames dropped/queued, the higher fps can be achieved.
