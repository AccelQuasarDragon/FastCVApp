...
def open_cvpipeline(*args):
    try:
        ...
        # F:\CODING\FastCVApp\FastCVApp\examples\creativecommonsmediac
        with open('F:\CODING\FastCVApp\FastCVApp\examples\creativecommonsmedia\pose_landmarker_full.task', 'rb') as f:
        # with open('F:\CODING\FastCVApp\FastCVApp\examples\creativecommonsmedia\pose_landmarker_lite.task', 'rb') as f:
                    modelbytes = f.read()
